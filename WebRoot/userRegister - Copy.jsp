...
<body>
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/URegisterServlet" method="post" style="margin-top: 5px;">
					<div class="form-group">
						<label for="username" class="col-sm-2 control-label">用户名</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="user_name" name="user_name"
								placeholder="请输入用户名" value="u1">
						</div>
					</div>
					<div class="form-group">
	...
	<!-- ------------------------------------------------- -->
		...
		<div class="content">
			...
			<p></p>
			<div align="center"><input type="button" value="注册" name="" class="registerbutton"/></div>
			<p style="text-align: center;">已有账号？立即<a href="#">登录</a></p>
		</div>
	</div>
